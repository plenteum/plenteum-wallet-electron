...
const PlenteumWalletApi = require('./ws_api');
...
var PlenteumWalletManager = function () {
    if (!(this instanceof PlenteumWalletManager)) {
        return new PlenteumWalletManager();
    }
...
PlenteumWalletManager.prototype._reinitSession = function () {
    this._wipeConfig();
    wsession.reset();
    this.notifyUpdate({
        type: 'sectionChanged',
...
PlenteumWalletManager.prototype._serviceBinExists = function () {
    wsutil.isFileExist(this.serviceBin);
};

// check 
PlenteumWalletManager.prototype.serviceStatus = function () {
    return (undefined !== this.serviceProcess && null !== this.serviceProcess);
};

PlenteumWalletManager.prototype.isRunning = function () {
    this.init();
...
PlenteumWalletManager.prototype._writeIniConfig = function (cfg) {
...
PlenteumWalletManager.prototype._writeConfig = function (cfg) {
    let configFile = wsession.get('walletConfig');
    if (!configFile) return '';
...
PlenteumWalletManager.prototype._wipeConfig = function () {
    try { fs.unlinkSync(wsession.get('walletConfig')); } catch (e) { }
};

PlenteumWalletManager.prototype.startService = function (walletFile, password, onError, onSuccess, onDelay) {
    this.init();
...
PlenteumWalletManager.prototype._spawnService = function (walletFile, password, onError, onSuccess, onDelay) {
    this.init();
...
PlenteumWalletManager.prototype.stopService = function () {
...
PlenteumWalletManager.prototype.terminateService = function (force) {
...
PlenteumWalletManager.prototype.startSyncWorker = function () {
    this.init();
    let wsm = this;
...
PlenteumWalletManager.prototype.stopSyncWorker = function () {
...
PlenteumWalletManager.prototype.getNodeFee = function () {
    let wsm = this;
...
PlenteumWalletManager.prototype.genIntegratedAddress = function (paymentId, address) {
    let wsm = this;
...
PlenteumWalletManager.prototype.createWallet = function (walletFile, password) {
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
...
PlenteumWalletManager.prototype.importFromKeys = function (walletFile, password, viewKey, spendKey, scanHeight) {
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
...
PlenteumWalletManager.prototype.importFromSeed = function (walletFile, password, mnemonicSeed, scanHeight) {
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
        scanHeight = scanHeight || 0;
...
PlenteumWalletManager.prototype.getSecretKeys = function (address) {
    let wsm = this;
    return new Promise((resolve, reject) => {
...
PlenteumWalletManager.prototype.sendTransaction = function (params) {
    let wsm = this;
    return new Promise((resolve, reject) => {
...
PlenteumWalletManager.prototype.rescanWallet = function (scanHeight) {
    let wsm = this;
...
PlenteumWalletManager.prototype._fusionGetMinThreshold = function (threshold, minThreshold, maxFusionReadyCount, counter) {
    let wsm = this;
    return new Promise((resolve, reject) => {
        counter = counter || 0;
...
PlenteumWalletManager.prototype._fusionSendTx = function (threshold, counter) {
    let wsm = this;
...
PlenteumWalletManager.prototype.optimizeWallet = function () {
    let wsm = this;
...
PlenteumWalletManager.prototype.networkStateUpdate = function (state) {
    ...
    if (state === 0) {
        ...
        this.init();
        // looks like wallet-service always stalled after disconnected, just kill & relaunch it
...
PlenteumWalletManager.prototype.notifyUpdate = function (msg) {
    uiupdater.updateUiState(msg);
};

PlenteumWalletManager.prototype.resetState = function () {
    return this._reinitSession();
};

module.exports = PlenteumWalletManager;
