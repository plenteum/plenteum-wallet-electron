...
function initApi(cfg) {
    if (wsapi instanceof PlenteumWalletApi) return;
    logDebug('Initializing PlenteumWalletApi');
    SERVICE_CFG = cfg;
    wsapi = new PlenteumWalletApi(SERVICE_CFG);
}
...
function checkBlockUpdate() {
    ...
    //let svc = new PlenteumWalletApi(SERVICE_CFG);
