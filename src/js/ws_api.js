...
class PlenteumWalletApi {
    constructor(args) {
        args = args || {};
        if (!(this instanceof PlenteumWalletApi)) return new PlenteumWalletApi(args);
    ...
    sendTransaction(params) {
        return new Promise((resolve, reject) => {
            ...
            if (parseFloat(params.fee) < 0.1) return reject(new Error('Minimum fee is 0.1 PLE'));
...
module.exports = PlenteumWalletApi;