...
var PlenteumWalletAddressBook = function (path, name, pass) {
    if (!(this instanceof PlenteumWalletAddressBook)) return new PlenteumWalletAddressBook(pass, name, path);
    this.path = path;
...
PlenteumWalletAddressBook.prototype.setParams = function (path, pass) {
    if (path) this.path = path;
    if (pass) this.pass = pass;
    return true;
};

PlenteumWalletAddressBook.prototype.create = function (ignoreExists) {
...
PlenteumWalletAddressBook.prototype.initFile = function () {
    return new Promise((resolve, reject) => {
        try {
...
PlenteumWalletAddressBook.prototype.load = function () {
    return new Promise((resolve, reject) => {
...
PlenteumWalletAddressBook.prototype.save = function (addressBookData) {
    return new Promise((resolve, reject) => {
        let gcm = new GCM(this.pass, this.cipherConfig);
...
module.exports = PlenteumWalletAddressBook;